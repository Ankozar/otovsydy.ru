...
// $source_url = 'https://72.xn--b1aew.xn--p1ai/news';
// $source_link_first_part = 'https://72.xn--b1aew.xn--p1ai';
...
// echo $document;
 ...
 $news_main_block = $document->find('.section-list');
    $news_blocks = $news_main_block->find('.sl-item');
    $i = 0;
